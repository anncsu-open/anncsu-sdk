...
if TYPE_CHECKING:
    from .jsonpost import JSONPost
    from .status import Status


class AnncsuCoordinate(BaseSDK):
    r"""ANNCSU REST API - COORDINATE - ACCESSI: API dei servizi REST di ANNCSU su PDND per aggiornamento delle coordinate degli accessi
    ...
    status: "Status"
    _sub_sdk_map = {
        "json_post": ("anncsu.coordinate.jsonpost", "JSONPost"),
        "status": ("anncsu.coordinate.status", "Status"),
    }
