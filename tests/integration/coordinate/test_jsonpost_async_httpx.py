"""Async integration tests for coordinate/jsonpost.py using pytest-httpx.

These tests mock HTTP responses at the httpx level to exercise
the full Speakeasy-generated async code path for coordinate management endpoints.
"""
...
class TestGestioneCoordinateAsync:
    """Async tests for gestionecoordinate endpoint."""

    @pytest.mark.asyncio
    async def test_gestionecoordinate_success(self, httpx_mock: HTTPXMock):
        """Test successful async coordinate operation."""
        ...
        response = await sdk.json_post.gestionecoordinate_async(
    ...
    @pytest.mark.asyncio
    async def test_gestionecoordinate_with_dict_input(self, httpx_mock: HTTPXMock):
        """Test async coordinate operation with TypedDict input."""
        httpx_mock.add_response(
            method="POST",
            url=f"{BASE_URL}/gestionecoordinate",
            json={
    ...
    @pytest.mark.asyncio
    async def test_gestionecoordinate_bad_request(self, httpx_mock: HTTPXMock):
        ...
        with pytest.raises(errors.RispostaErrore) as exc_info:
            await sdk.json_post.gestionecoordinate_async(
                richiesta=models.Richiesta(
                    accesso=models.Accesso(
                        codcom="INVALID",
                        progr_civico="00001",
    ...
    @pytest.mark.asyncio
    async def test_gestionecoordinate_unauthorized(self, httpx_mock: HTTPXMock):
        """Test 401 Unauthorized error handling in async."""
        httpx_mock.add_response(
            method="POST",
            url=f"{BASE_URL}/gestionecoordinate",
            json={
    ...
    @pytest.mark.asyncio
    async def test_gestionecoordinate_not_found(self, httpx_mock: HTTPXMock):
    ...
    @pytest.mark.asyncio
    async def test_gestionecoordinate_internal_server_error(
    ...
    @pytest.mark.asyncio
    async def test_gestionecoordinate_with_security(self, httpx_mock: HTTPXMock):
        """Test async SDK operation with security configured."""
        httpx_mock.add_response(
            method="POST",
            url=f"{BASE_URL}/gestionecoordinate",
            json={
    ...
    @pytest.mark.asyncio
    async def test_gestionecoordinate_request_body_json(self, httpx_mock: HTTPXMock):
        """Test that async request body is sent as JSON."""
        httpx_mock.add_response(
            method="POST",
            url=f"{BASE_URL}/gestionecoordinate",
            json={
    ...
    @pytest.mark.asyncio
    async def test_gestionecoordinate_generic_4xx_error(self, httpx_mock: HTTPXMock):
    ...
    @pytest.mark.asyncio
    async def test_gestionecoordinate_generic_5xx_error(self, httpx_mock: HTTPXMock):
...
class TestGestioneCoordinateAsyncWithCustomServerUrl:
    """Async tests for coordinate operations with custom server URL."""

    @pytest.mark.asyncio
    async def test_with_validation_environment(self, httpx_mock: HTTPXMock):
        """Test async SDK with validation environment URL."""
...
class TestGestioneCoordinateAsyncResponseData:
    """Async tests for response data parsing."""

    @pytest.mark.asyncio
    async def test_response_with_full_dati(self, httpx_mock: HTTPXMock):
        """Test async response with complete dati structure."""
        httpx_mock.add_response(
            method="POST",
            url=f"{BASE_URL}/gestionecoordinate",
            json={
    ...
    @pytest.mark.asyncio
    async def test_response_with_multiple_dati(self, httpx_mock: HTTPXMock):
        """Test async response with multiple dati entries."""
        httpx_mock.add_response(
            method="POST",
            url=f"{BASE_URL}/gestionecoordinate",
            json={
    ...
    @pytest.mark.asyncio
    async def test_response_with_empty_dati(self, httpx_mock: HTTPXMock):
        """Test async response with empty dati list."""
        httpx_mock.add_response(
            method="POST",
            url=f"{BASE_URL}/gestionecoordinate",
            json={
