"""Base SDK class for ANNCSU API clients.

This module provides the base SDK infrastructure shared by all ANNCSU API packages.
Based on Speakeasy-generated code, adapted for multi-API support.
"""
...
class BaseSDK:
    """Base class for all ANNCSU SDK implementations."""

    sdk_configuration: SDKConfigurationProtocol

    def __init__(self, sdk_config: SDKConfigurationProtocol) -> None:
