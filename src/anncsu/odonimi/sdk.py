...
if TYPE_CHECKING:
    from .odonimi import Odonimi
    from .status import Status


class AnncsuOdonimi(BaseSDK):
    r"""ANNCSU REST API - ODONIMI: API dei servizi REST di ANNCSU su PDND per aggiornamento adonimi
    ...
    status: "Status"
    _sub_sdk_map = {
        "anncsu": ("anncsu.odonimi.odonimi", "Odonimi"),
        "status": ("anncsu.odonimi.status", "Status"),
    }
