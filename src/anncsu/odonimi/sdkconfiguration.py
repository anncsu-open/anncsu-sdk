...
SERVERS = [
    "https://modipa.agenziaentrate.it/govway/rest/in/AgenziaEntrate-PDND/anncsu-aggiornamento-odonimi/v1",
    # l'accesso all'API e' protetta dai controlli di accesso su GovWay
    "https://modipa-val.agenziaentrate.it/govway/rest/in/AgenziaEntrate-PDND/anncsu-aggiornamento-odonimi/v1",
    # l'accesso all'API di validazione e' protetta dai controlli di accesso su GovWay
]
